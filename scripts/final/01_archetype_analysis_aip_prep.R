...
aip <- read_dta("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/original/aip_files/aip_counties_ideology_v2022a.dta")

## 1.1
## Filter the data for the years 2017-2021
## Select variables and rename county_fips to FIPS
