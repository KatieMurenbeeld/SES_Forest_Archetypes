...
# Load the rasters
aip_crop <- rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/aip_3km_pred_crop_2024-09-30.tif")
bric_crop <- rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/bric_commcap_3km_pred_crop_2024-09-30.tif")
netmig_crop <- rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/net_mig_2023_3km_pred_crop_2024-09-30.tif")
forpay_crop <- rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/pct_forpay_3km_pred_crop_2024-09-30.tif")
forprod_crop <- rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/fia_for_prod_3km_pred_crop_2024-09-30.tif")
lesshs_crop <- rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/cejst_lesshs_3km_pred_crop_2024-09-30.tif")
hsburd_crop <- rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/cejst_houseburd_3km_pred_crop_2024-09-30.tif")
engburd_crop <- rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/cejst_engburd_3km_pred_crop_2024-09-30.tif")
pm25_crop <- rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/cejst_pm25_3km_pred_crop_2024-09-30.tif")
travtime_crop <- rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/trav_time_3000m_2024-10-03.tif")
rough_crop <-  rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/roughness_3000m_2024-10-07.tif")
precseas_crop <-  rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/prec_seas_3000m_2024-10-07.tif")
tempseas_crop <-  rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/temp_seas_3000m_2024-10-07.tif")
distwild_crop <-  rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/dist_to_wild_3km_pred_crop_2024-10-01.tif")
distcrit_crop <-  rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/dist_to_crithab_3km_pred_crop_2024-10-01.tif")
millchng_crop <-  rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/millchange_interp-2_2024-10-04.tif")
fedrich_crop <-  rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/conus_fed_rich_crop_2024-10-01.tif")
treecov_crop <-  rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/conus_tree_cover_crop_2024-10-08.tif")
treeage_crop <-  rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/conus_tree_age_crop_2024-10-08.tif")
forgain_crop <- rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/forest_gain_3km_crop_2024-10-01.tif")
whp_crop <-  rast("/Users/katiemurenbeeld/Analysis/SES_Forest_Archetypes/data/processed/variables/merged/conus_whp_3km_agg_interp_crop_2024-09-27.tif")
